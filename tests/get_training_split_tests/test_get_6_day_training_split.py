...
class TestGet6DayTrainingSplit:
    sets_per_muscle = {
        "abdominals": 3,
        "abductors": 2,
        "adductors": 2,
    ...
    def test_no_preferred_or_excluded(self):
        result = get_6_day_training_split([], [], self.sets_per_muscle)
        print(f"6-day split: {result}")
        expected = [
            ([
                ('chest', 3),
                ('triceps', 3),
    ...
    def test_exclude_minor_muscles(self):
        ...
        result = get_6_day_training_split(excluded, [], self.sets_per_muscle)
        expected = [
            ([
                ('chest', 3),
                ('triceps', 3),
    ...
    def test_exclude_back_abs_adds_prefer_lower_back_and_bis(self):
        ...
        result = get_6_day_training_split(excluded, preferred, self.sets_per_muscle)
        print(f"6-day split: {result}")
        expected = [
            ([
                ('chest', 3),
